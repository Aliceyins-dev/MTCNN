...
import time
import numpy as np
from Tools.utilsv2 import convert_to_square, softnms
...
class Detector:
    ...
    def __pnet_detect(self, image):
        ...
        while min_side_len > 12:
            ...
            boxes = softnms(np.array(boxes), thresh_iou=0.3, thresh_conf=0.1, isMin=False)
            bboxes.extend(boxes)
    ...
    def __rnet_detect(self, image, pnet_boxes):
        ...
        indexes, _ = np.where(classify > 0.7)   # shape(10,) [ 0  1  2  3  4  5  9 24 33 42]
        ...
        return softnms(np.array(boxes), thresh_iou=0.3,thresh_conf=0.05, isMin=False)
    ...
    def __onet_detect(self, image, rnet_boxes):
        ...
        return softnms(np.array(boxes), thresh_iou=0.3, thresh_conf=0.8, isMin=True)
